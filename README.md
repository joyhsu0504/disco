...
This code is based on the FiLM: Visual Reasoning with a General Conditioning Layer repository. Our framework, DisCo, can be found in the disco_scripts folder. 
...
To run DisCo with GAN generation:
